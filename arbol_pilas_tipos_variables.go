...
func leerCadenas() (map[string][]string, []string, []string) {
...
func tiposVariables(arreglo []string) []string{
...
func main() {
  mapa,cadena,tiposV := leerCadenas()
